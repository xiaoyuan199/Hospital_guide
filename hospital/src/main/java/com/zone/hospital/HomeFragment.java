...
import com.zone.hospital.weidge.CallNumActivity;
        ...
        switch (view.getId()) {
            case R.id.ivBt1:
             //   mSpeechSynthesizer.speak("这是医院介绍");
              post.poststring(j2str.ttsword("这是医院介绍"));
                Log.e("text","这是医院介绍");
            ...
            case R.id.ivBt2:
              ...
              //  mSpeechSynthesizer.speak("这是医生简介");
                post.poststring(j2str.ttsword("这是医生简介"));
            ...
            case R.id.ivBt6:
              //  mSpeechSynthesizer.speak("这是办事流程");
                post.poststring(j2str.ttsword("这是办事流程"));
                Intent intent4 = new Intent(getActivity(), WebViewActivity.class);
                intent4.putExtra("title", "办事流程");
                intent4.putExtra("nothild",true);
                intent4.putExtra("url", "http://dr.trickyedecay.me/gp.html");
                startActivity(intent4);
                break;
            case R.id.ivBt7:
                post.poststring(j2str.ttsword("这是排队取号"));
               // mSpeechSynthesizer.speak("这是保健知识");
                Intent intent2 = new Intent(getActivity(), CallNumActivity.class);
                intent2.putExtra("title", "排队取号");
