...
public class SmartDiagnosisActivity extends BaseActivity2 {
    ...
    FlashPoit mTvUpThroat;
    FlashPoit mTvDownThroat;
    FlashPoit mTvUpabdomen;
    FlashPoit mTvUpLeftLeg1;
    FlashPoit mTvUpRightLeg1;
    FlashPoit mTvDownLeftLeg1;
    FlashPoit mTvDownRightLeg1;
    @InjectView(R.id.tv_up_left_arm1)
    Button tvUpLeftArm1;
    @InjectView(R.id.tv_up_right_arm1)
    Button tvUpRightArm1;
    ...
    public void init() {
        ...
        post.poststring(j2str.ttsword("点击部位查询症状"));
        ...
        mTvUpThroat = (FlashPoit) findViewById(R.id.tv_up_throat);
        mTvDownThroat = (FlashPoit) findViewById(R.id.tv_down_throat);
        mTvUpabdomen = (FlashPoit) findViewById(R.id.tv_up_abdomen);
        mTvUpLeftLeg1 = (FlashPoit) findViewById(R.id.tv_up_left_leg1);
        mTvUpRightLeg1 = (FlashPoit) findViewById(R.id.tv_up_right_leg1);
        mTvDownLeftLeg1 = (FlashPoit) findViewById(R.id.tv_down_left_leg1);
        mTvDownRightLeg1 = (FlashPoit) findViewById(R.id.tv_down_right_leg1);
...
//        mTvUpThroat.startAnimation(initscaleanim());
//        mTvDownThroat.startAnimation(initscaleanim());
//        mTvUpabdomen.startAnimation(initscaleanim());
//        mTvUpLeftLeg1.startAnimation(initscaleanim());
//        mTvUpRightLeg1.startAnimation(initscaleanim());
//        mTvDownLeftLeg1.startAnimation(initscaleanim());
//        mTvDownRightLeg1.startAnimation(initscaleanim());
//    }
...
//    }
    ...
    @OnClick({R.id.tv_up_left_arm1, R.id.tv_up_right_arm1, R.id.tv_up_throat, R.id.tv_down_throat, R.id.tv_up_abdomen, R.id.tv_up_left_leg1, R.id.tv_up_right_leg1, R.id.tv_down_left_leg1, R.id.tv_down_right_leg1, R.id.layout_return, R.id.tv_sex, R.id.tv_up_head, R.id.tv_up_left_arm, R.id.tv_up_back, R.id.tv_up_right_arm, R.id.tv_up_left_hand, R.id.tv_up_left_pap, R.id.tv_up_right_pap, R.id.tv_up_right_hand, R.id.tv_up_left_leg, R.id.tv_up_right_leg, R.id.tv_up_left_foot, R.id.tv_up_right_foot, R.id.tv_down_head, R.id.tv_down_left_arm, R.id.tv_down_back, R.id.tv_down_right_arm, R.id.tv_down_left_hand, R.id.tv_down_left_pap, R.id.tv_down_right_pap, R.id.tv_down_right_hand, R.id.tv_down_left_leg, R.id.tv_down_right_leg, R.id.tv_down_left_foot, R.id.tv_down_right_foot})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_up_throat:
            case R.id.tv_down_throat:
                MyApplication.setWhere("脖子");
                MyApplication.setWheretag("14");
            ...
            case R.id.tv_sex:
                if (isMan) {
                    ...
                    post.poststring(j2str.ttsword("女"));
//                    showToast("转为女");
...
//                    lp.setMargins(0, (i - 1) * ((int) (screenHeight / 13) + 1), 0, 1);
                    ...
                    post.poststring(j2str.ttsword("男"));
                    MyApplication.setSex("男");
//                    showToast("转为男");
                    ObjectAnimator animator = ObjectAnimator.ofFloat(mLayoutUp, "alpha", 0f, 180f);
                    animator.setDuration(1500);
...
//            腿
            case R.id.tv_up_left_leg1:
            case R.id.tv_down_left_leg1:
            case R.id.tv_up_left_leg:
                ...
                break;
            case R.id.tv_down_right_leg1:
            case R.id.tv_up_right_leg1:
