...
//        list.add(new StuDirBean("肩关节疼痛"));
        switch (MyApplication.getListTag()) {
            ...
            case "10":
                ...
                break;
            case "11":
                setLrvAdapter(SmartConsultModel.getThroat());
                break;
        }
        switch (MyApplication.getWheretag()) {
            case "1":
                post.poststring(j2str.ttsword("这是脸部,请选择你需要了解的症状"));
               // mSpeechSynthesizer.speak("这是脸部,请选择你需要了解的症状");
                break;
            case "2":
             //   mSpeechSynthesizer.speak("这是后脑,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是后脑,请选择你需要了解的症状"));
                break;
            case "3":
             //   mSpeechSynthesizer.speak("这是腹部,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是腹部,请选择你需要了解的症状"));
                break;
            case "4":
               // mSpeechSynthesizer.speak("这是背部,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是背部,请选择你需要了解的症状"));
                break;
            case "5":
             //   mSpeechSynthesizer.speak("这是左手臂,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是左手臂,请选择你需要了解的症状"));
                break;
            case "6":
              //  mSpeechSynthesizer.speak("这是右手臂,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是右手臂,请选择你需要了解的症状"));
                break;
            case "7":
              //  mSpeechSynthesizer.speak("这是左手,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是左手,请选择你需要了解的症状"));
                break;
            case "8":
                //mSpeechSynthesizer.speak("这是右手,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是右手,请选择你需要了解的症状"));
                break;
            case "9":
               // mSpeechSynthesizer.speak("这是左腿,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是左腿,请选择你需要了解的症状"));
                break;
            case "10":
             //   mSpeechSynthesizer.speak("这是右腿,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是右腿,请选择你需要了解的症状"));
                break;
            case "11":
               // mSpeechSynthesizer.speak("这是左脚,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是左脚,请选择你需要了解的症状"));
                break;
            case "12":
              //  mSpeechSynthesizer.speak("这是右脚,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是右脚,请选择你需要了解的症状"));
                break;
            case "13":
              //  mSpeechSynthesizer.speak("请选择你需要了解的症状");
                post.poststring(j2str.ttsword("请选择你需要了解的症状"));
                break;
            case "14":
                //mSpeechSynthesizer.speak("这是脖子,请选择你需要了解的症状");
                post.poststring(j2str.ttsword("这是脖子,请选择你需要了解的症状"));
                break;
        }
    }
