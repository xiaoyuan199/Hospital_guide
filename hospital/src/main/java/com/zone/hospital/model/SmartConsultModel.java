...
public class SmartConsultModel {
    ...
    public static List<SicknissBean> getThroat() {
        return throat;
    }

    public static void setThroat(List<SicknissBean> throat) {
        SmartConsultModel.throat = throat;
    }

    private static List<SicknissBean> throat;//11
...
//                , new String[]{"中风","营养不良","急性脊髓炎","周围神经病"}));
        ...
        throat=new ArrayList<>();
        throat.add(new SicknissBean("咽部不适"
                , new String[]{"咽痛","淋巴结肿大","发热","干咳"}
                , new String[]{}
                , new String[]{}
                , new String[]{"扁桃体炎","咽炎","喉炎"}));
        throat.add(new SicknissBean("恐水"
                , new String[]{"乏力","动物咬伤史"}
                , new String[]{}
                , new String[]{}
                , new String[]{"狂犬病"}));

        throat.add(new SicknissBean("颈肩酸痛"
                , new String[]{"上肢疼痛","头晕，头晕","颈部创伤史","姿势不良"}
                , new String[]{}
                , new String[]{}
                , new String[]{"颈椎病"}));
    }
